...
const PageHeader = ({ badge, title, description, children }: PageHeaderProps) => {
  return (
    <div className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-secondary/20 rounded-full blur-[100px] animate-pulse-glow delay-1000" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-display font-bold tracking-wider mb-6"
          >
